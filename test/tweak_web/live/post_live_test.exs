defmodule TweakWeb.PostLiveTest do
  use TweakWeb.ConnCase

  import Phoenix.LiveViewTest

  alias Tweak.Timeline

  @create_attrs %{body: "some body", likes: 42, reposts: 42, username: "some username"}
  @update_attrs %{
  ...
  @invalid_attrs %{body: nil, likes: nil, reposts: nil, username: nil}
